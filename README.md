...
1. 프로그램 실행 후 help를 통해 명령어 목록을 볼 수 있습니다. 
...
3. 명령어 뒤에 필요한 내용이 있다면, 실행 시 사용법을 알려줍니다.

> `rental-rent` 의 예시

```text
명령어: rental-rent
=> 사용법: rental-rent [comic.id] [member.id]

명령어: rental-rent 2 2
=> 해당 회원은 연체 패널티로 인해 2026-04-01 까지 대여가 불가능합니다.

명령어: rental-rent 2 3
=> 대여가 완료되었습니다. 반납 예정일은 2026-03-27 입니다.

명령어: rental-list
대여번호 | 만화책번호 | 회원번호 | 대여일 | 반납예정일 | 실제반납일
-----------------------------------------------------------------
2 | 2 | 3 | 2026-03-20 | 2026-03-27 | 미반납
1 | 2 | 2 | 2026-03-19 | 2026-03-26 | 2026-03-29
-----------------------------------------------------------------
```
